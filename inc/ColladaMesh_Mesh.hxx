...
#define _ColladaMesh_Mesh_HeaderFile
...
//!          value. <br>
//! <br>
class ColladaMesh_Mesh : public MMgt_TShared {

public:

  //! Creates an empty mesh. <br>
  Standard_EXPORT   ColladaMesh_Mesh();
...
//!          <DomainIndex>. <br>//! Raised if <DomainIndex> is lower than 1 or greater <br>
//!          than the number of domains. <br>
  Standard_EXPORT   virtual const ColladaMesh_SequenceOfMeshTriangle& Triangles(const Standard_Integer DomainIndex = 1) const;
...
//!          than the number of domains. <br>
  ...
  DEFINE_STANDARD_RTTI(ColladaMesh_Mesh)
...
ColladaMesh_SequenceOfMeshDomain domains;
gp_XYZ xyzmax;
gp_XYZ xyzmin;
