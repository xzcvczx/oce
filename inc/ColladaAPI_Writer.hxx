...
#ifndef _ColladaAPI_Writer_HeaderFile
#define _ColladaAPI_Writer_HeaderFile
...
//! SetDeflection. These parameters may be modified. <br>
  Standard_EXPORT   ColladaAPI_Writer();
...
Handle_ColladaMesh_Mesh theColladaMesh;
