...
#ifndef _RWCollada_HeaderFile
#define _RWCollada_HeaderFile
...
//!         Returns false if the cannot be opened; <br>
  Standard_EXPORT   static  Standard_Boolean WriteZAE(const Handle(ColladaMesh_Mesh)& aMesh,const OSD_Path& aPath,const Handle(Message_ProgressIndicator)& aProgInd = NULL) ;
  //! write the meshing in a file following the <br>
//!         Ascii  format of an STL file. <br>
//!         Returns false if the cannot be opened; <br>
  Standard_EXPORT   static  Standard_Boolean WriteDAE(const Handle(ColladaMesh_Mesh)& aMesh,const OSD_Path& aPath,const Handle(Message_ProgressIndicator)& aProgInd = NULL) ;
...
//!         that it is a binary file. <br>
  Standard_EXPORT   static  Handle_ColladaMesh_Mesh ReadFile(const OSD_Path& aPath,const Handle(Message_ProgressIndicator)& aProgInd = NULL) ;
...
//!        type (often real) <br>
  Standard_EXPORT   static  Handle_ColladaMesh_Mesh ReadZAE(const OSD_Path& aPath,const Handle(Message_ProgressIndicator)& aProgInd = NULL) ;
  //! Read a meshing from a binary file <br>
//!        Raises NoMoreObject from Standard if a statement <br>
//!        does not contain the right number of tokens <br>
//!        Raises TypeMisMatch if a token has not the good <br>
...
//!        having found the word endsolid; <br>
  Standard_EXPORT   static  Handle_ColladaMesh_Mesh ReadDAE(const OSD_Path& aPath,const Handle(Message_ProgressIndicator)& aProgInd = NULL) ;
