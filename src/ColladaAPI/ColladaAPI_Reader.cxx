...
ColladaAPI_Reader::ColladaAPI_Reader() {}

void ColladaAPI_Reader::Read(TopoDS_Shape& aShape, const Standard_CString aFileName) 
{
  OSD_Path aFile(aFileName);
  
  Handle(ColladaMesh_Mesh) aSTLMesh = RWCollada::ReadFile(aFile);
  ...
  ColladaMesh_MeshExplorer aMExp (aSTLMesh);
